...
def test_vlm_model_for_plan_type_defaults_to_base():
    cfg = Settings(
        house_diy_omlx_vlm_model="house-vlm-pro",
        house_diy_omlx_vlm_model_cad="",
        house_diy_omlx_vlm_model_marketing="",
    )
    assert cfg.vlm_model_for_plan_type("cad_lineart") == "house-vlm-pro"
    assert cfg.vlm_model_for_plan_type("marketing_color") == "house-vlm-pro"
    assert cfg.vlm_model_for_plan_type("unknown") == "house-vlm-pro"
