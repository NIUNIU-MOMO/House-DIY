...
| `Qwen3-VL-4B-Instruct-4bit` | `house-vlm` | 户型图理解（默认） |
| 同上或更强 VLM（如 Qwen2-VL-7B） | `house-vlm-cad` | **可选** CAD 线稿专用 alias |
| 同上或彩色图表现更好者 | `house-vlm-mkt` | **可选** 营销彩图专用 alias |
